...
const translations: Record<string, string> = {
  ...
  "最近 24 小時 · 分數 50+ · ": "LAST 24 HOURS · SCORE 50+ · ", " 個訊號": " SIGNALS", "每日報告 / ": "Daily report / ", "已儲存的客觀摘要": "Persisted deterministic digest", "訊號概況": "Signal balance", "新增": "NEW", "待定": "TBD", "未知來源": "unknown source", "尚無已評分的變化。": "No scored changes yet.", "請執行資料蒐集流程，將來源快照轉換為第一筆市場差異。": "Run the collector pipeline to turn source snapshots into the first market diff.",
  ...
  "系統狀態": "System status", "資料來源": "Source", "健康度。": "health.", "蒐集器與 API 分開執行，每一次嘗試都會留下工作紀錄。": "Collectors run separately from the API, with every attempt recorded as a job run.", "已擷取 ": "", " 筆失敗": " failed", "筆變化": "changes", "目前無法取得工作資料。": "Job data is unavailable.",
